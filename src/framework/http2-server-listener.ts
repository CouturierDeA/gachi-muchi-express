...
export const onHttp2Stream = async (
    ...
    try {
        ...
        const request = new RequestEntity<ServerHttp2Stream>(sandbox, req, res, stream, commonHeaders, path, method)
        const response = new ResponseEntity<ServerHttp2Stream>(sandbox, req, res, stream)
